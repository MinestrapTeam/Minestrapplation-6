...
public class ContainerMelter extends Container {
    ...
    public ContainerMelter(int window, World world, BlockPos pos, PlayerInventory inv, PlayerEntity player){
        super(ContainerTypes.MELTER_CONTAINER.get(), window);
        te = (TileEntityMelter) world.getTileEntity(pos);
        this.player = player;
